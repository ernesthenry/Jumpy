...
var platforms;
var hitPlatform, player, cursors, stars, scoreText, score=0;
...
var ground = platforms.create(0,
  game.world.height-64, 'ground');
  //make it cover the bottom
...
function update(){
  ...
  if(cursors.left.isDown) //if press left arrow keyboard
  {
